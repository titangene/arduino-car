...
void action() {
    if (dist_R_AVE > dist_CLR_min) {
        ...
        if (dist_C_AVE > dist_CLR_min) {
            ...
            backward(200);
            BT.println("Back");
            dist_L_AVE = get_dist('Left', dist_L, dist_L_AVE);
            BT.print("L: ");
            BT.println(dist_L_AVE);
